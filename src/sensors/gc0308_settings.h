...
/*
 * GC0308 default initialization register table.
 * Ported verbatim from esp32-camera's private_include/gc0308_settings.h
 ...
 */
#ifndef __GC0308_SETTINGS_H__
#define __GC0308_SETTINGS_H__
...
static const uint16_t gc0308_default_init_regs[][2] = {
    {0xfe, 0x00},
    {0xec, 0x20},
    {0x05, 0x00},
    {0x06, 0x00},
