/**
 * @file ov3660_regs.h
 * @brief OV3660 register definitions (16-bit addresses).
 *
 * Ported verbatim from esp32-camera's sensors/private_include/ov3660_regs.h.
 */
#ifndef __OV3660_REGS_H__
#define __OV3660_REGS_H__

/* product ID registers */
#define REG_PIDH        0x300A  // Product ID high byte (0x36)
#define REG_PIDL        0x300B  // Product ID low byte  (0x60)
